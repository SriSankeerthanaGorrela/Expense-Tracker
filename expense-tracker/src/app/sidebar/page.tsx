...
export function Sidebar() {
  ...
  return (
    <aside className="w-40 bg-white dark:bg-slate-800 border-r border-slate-200 dark:border-slate-700 flex flex-col">
      {/* Main Nav */}
      ...
      <div className="mt-auto px-2 mb-4 space-y-2">
        ...
        <button className="flex items-center gap-3 w-full px-3 py-2 text-red-600 hover:bg-red-100 dark:hover:bg-red-900/20 rounded-lg">
          <LogOut size={20} />
          <span>Logout</span>
        </button>
      </div>
