    ...
    <nav className="bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 sticky top-0 z-40">
      <div className="px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-slate-900 dark:text-white">Expensely</h1>
            <p className="text-slate-500 dark:text-slate-400">Track, Save, Grow</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="w-10 h-10 rounded-full bg-emerald-500 flex items-center justify-center text-white cursor-pointer">
            <span>SK</span>
          </div>
        </div>
      </div>
